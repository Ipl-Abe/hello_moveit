...
int main(int argc, char ** argv)
{
  ...
  // Construct and initializ MoveItVisualTools
  ...
  // which could be changed using the MoveGroupInterface::setStartState* family of functions (but is not in this tutorial).
